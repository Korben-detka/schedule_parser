Этот проект является форком [schedule_parser](https://github.com/MPSU/schedule_parser) от [MPSU](https://github.com/MPSU).
...
**Изменения:**
 ...
 - Добавлена возможность добавлять к названию дисциплины префикс и постфикс
